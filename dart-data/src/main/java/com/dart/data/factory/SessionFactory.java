...
public interface SessionFactory {
     ...
     * @param ipAddress the IP address of the machine where this session is associated with.
     ...
     */
    Session createSession(String token, User user, String ipAddress, Date expiry, String device, String browser, String location);
}
