...
public class GoogleTokenVerificationServiceTest {
    ...
    public void testVerifyToken() throws Exception {
        ...
        PropertiesProvider.ThirdPartyApi mockGplus = mock(PropertiesProvider.ThirdPartyApi.class);
        when(mockProps.getGplus()).thenReturn(mockGplus);
        when(mockGplus.getAppId()).thenReturn("");
